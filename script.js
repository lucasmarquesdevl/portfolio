const translations = {
    ...
    en: {
        ...
        hero_title: "IT Analyst & <span class='text-white'>Full Stack Developer</span> focused on AI.",
        about_header: "About",
        about_text: "Graduated in Systems Analysis and Development at Centro Universitário Serra dos Órgãos – UNIFESO (Teresópolis), I followed a path of constant evolution: from a solid base in support and networks at Saquarema City Hall to the development of complex software. My goal is to integrate AI and MySQL databases to deliver Full Stack solutions that solve real problems in an innovative way.",
    ...
    es: {
        ...
        hero_title: "IT Analyst & <span class='text-white'>Full Stack Developer</span> enfocado en IA.",
        about_header: "Sobre",
        about_text: "Graduado en Análisis y Desarrollo de Sistemas en el Centro Universitário Serra dos Órgãos – UNIFESO (Teresópolis), seguí un camino de constante evolución: desde una base sólida de soporte y redes en la Municipalidad de Saquarema hasta el desarrollo de software complejo. Mi objetivo es integrar bases de datos AI y MySQL para entregar soluciones Full Stack que resuelvan problemas reales de una manera innovadora.",
